...
public class jogoDaVelha {
    ...
    public static void main(String[] args) {
        ...
        char [][] jogoVelha = new char [3][3]; //primeira estrutura -Matriz
        String [] nomeJogador = new String [2]; //segunda estrutura de dados -Vetor
        
        System.out.println("Digite o nome do primeiro jogador: ");
        nomeJogador[0] = input.nextLine();
        System.out.println("Digite o nome do segundo jogador: ");
          nomeJogador[1] = input.nextLine(); //usando a segunda estrutura
        
        
        System.out.println(nomeJogador[0] + " = X");
        System.out.println(nomeJogador[1] +" = O");
        ...
        while (!ganhou){
            if (jogada %2 == 1){
                ...
                System.out.println("Vez de " + nomeJogador[0] + "\n" + "Escolha linha e coluna (1-3)");
                sinal = 'X';
            
            }else{
                
                System.out.println("Vez de " + nomeJogador[1] + "\n" + "Escolha linha e coluna (1-3)");
                sinal = 'O';
            }
        ...
        if (jogoVelha[linha][coluna] == 'X' || jogoVelha[linha][coluna] == 'O'){ //usando primeira estrutura
            ...
            if((jogoVelha[0][0] == 'X' && jogoVelha[0][1] == 'X' && jogoVelha[0][2] == 'X') || //usando primeira estrutura
                ...
                ganhou = true;
                System.out.println("Parabens, " + nomeJogador[0] + " ganhou!");
                ...
                ganhou = true;
                System.out.println("Parabens, " + nomeJogador[1] + " ganhou!");
